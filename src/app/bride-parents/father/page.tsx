...
const brideParentsFatherOgImagePath = "/image/optimized/large/HIS07303.jpg";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: brideParentsFatherOgImagePath,
        alt: "신부 혼주용 메인 이미지",
      },
    ],
  },
  twitter: {
    ...
    title: "성윤 💕 민지 결혼식 초대장",
    description: "2026년 7월 11일 토요일 17시, 르비르모어 선릉",
    images: [brideParentsFatherOgImagePath],
  },
};

export default function BrideParentsFatherPage() {
  return (
    <WeddingInvitationPage
      heroImageSrc={brideParentsFatherOgImagePath}
      showCountdown={false}
      showGallery
