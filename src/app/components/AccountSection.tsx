...
const DEFAULT_ACCOUNT_ITEMS: AccountItem[] = [
  {
    id: "groom",
    label: "신랑 계좌",
    number: "110557648615",
    detail: "신한은행 홍성윤",
    copyValue: "신한은행 110557648615 홍성윤",
  },
  {
    id: "bride",
    label: "신부 계좌",
...
export default function AccountSection({ items = DEFAULT_ACCOUNT_ITEMS }: AccountSectionProps) {
